            ...
            <div className='flex items-center justify-center gap-7 overflow-hidden'>
                {
                    categories.map((item, i) => (
                        <div
                            ...
                            <img src={item?.image} className={`hover:border-green-500 hover:border-2 hover:scale-110 transition-all duration-700 group rounded-full w-9 sm:w-16 ${category === item.Title ? "Active" : ""}`} alt="" />
