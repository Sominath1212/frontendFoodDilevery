...
function Cart() {
  ...
  return (
    <>
      <div className='bg-gray-400 h-[100vh] text-black pt-10 px-3'>

        <div className="sm:grid grid-cols-5 grid-rows-5 gap-4">
          <div className="bg-white col-span-3 row-span-5 border sm:min-h-[90vh]">
          ...
          <div className=" col-span-2 row-span-5 col-start-4 border p-5 rounded-lg">
            ...
            <div className='flex justify-between  px-2 py-1 rounded-md items-center my-4 bg-gray-400  bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border border-gray-100'>
              <input type="radio"  />
              <span> PayPal</span>
              <img src={PaypalImage} width={20} height={20} className='mix-blend-multiply' alt="" />
            </div>
            <div className='flex justify-between border px-2 py-1 rounded-md items-center my-4'>
              <input type="radio"  />
              <span>PhonePay</span>
            ...
            <div className='flex text-sm my-5 mx-[5%] space-x-1'>
              <input type="checkbox" name="" id="" /> <p>Agree with all terms & condintions of ordering </p>
            </div>
            
          <button className='font-bold border bg-green-500 hover:scale-110 duration-700 transition-all text-black px-2 relative self-center py-1 rounded-sm mx-[5%] w-[90%] '>Order Now</button>
