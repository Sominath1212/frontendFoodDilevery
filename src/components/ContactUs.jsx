  ...
  return (
    <div className='w-full h-[100vh] bg-gray-400 flex items-center justify--center '>
      <div className=' bg-white border-2 rounded-lg min-w[500px] my-auto mx-auto p-5 shadow-lg text-black'>
        ...
        <p className='text-sm text-green-500 '>Please fill this form in a decent manner</p>
        ...
        <form >
          ...
          <button className='font-bold border bg-green-500 hover:scale-110 duration-700 transition-all text-black px-2 relative self-center py-1 rounded-lg mx-auto '>Submit</button>
        </form>
      </div>
    </div>
  )
